...
public class MainController implements Initializable {
	...
	@FXML
	private TableColumn<Book, String> bookWritersColumn;
	@FXML
	private TableColumn<Book, String> bookGenresColumn;
	@FXML
	...
	@FXML
	private Button btnRefreshBookTable;
	// Writer Tab
	@FXML
	private TableView<Writer> writerTable;
	@FXML
	private TableColumn<Writer, Integer> writerIDColumn;
	@FXML
	private TableColumn<Writer, String> writerNameColumn;
	@FXML
	private TableColumn<Writer, String> writerSurnameColumn;
	@FXML
	private TableColumn<Writer, String> writerEmailColumn;
	@FXML
	...
	@FXML
	private TableColumn<Publisher, Integer> publisherIDColumn;
	@FXML
	private TableColumn<Publisher, String> publisherNameColumn;
	@FXML
	private TableColumn<Publisher, String> cnpjColumn;
	@FXML
	private TableColumn<Publisher, String> publisherEmailColumn;
	@FXML
	private TableColumn<Publisher, String> publisherPhoneColumn;
	@FXML
	...
	private void removeBook() {
		...
		try {
			...
			Book book = selectionModel.getSelectedItem();
	...
	private void initWriterTable() {
		...
		writerIDColumn.setCellValueFactory(
		...
		writerNameColumn.setCellValueFactory(
		...
		writerSurnameColumn.setCellValueFactory(
				new Callback<TableColumn.CellDataFeatures<Writer, String>, ObservableValue<String>>() {
		...
		writerEmailColumn.setCellValueFactory(
				new Callback<TableColumn.CellDataFeatures<Writer, String>, ObservableValue<String>>() {
